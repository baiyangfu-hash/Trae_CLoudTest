...
主控程序 [PRG_MainControl_DJ2026005_V4.1.0.st](主控/PRG_MainControl_DJ2026005_V4.1.0.st) 采用结构化设计，主要包括：
...
| 文档类型 | 文档名称 | 核心内容 |
|---------|:--------|:--------|
| **详细设计说明书 (DSN)** | [详细设计说明书_DSN-FB1001-Conveyor4Layer-V4.1.0.md](四层输送机/详细设计说明书_DSN-FB1001-Conveyor4Layer-V4.1.0.md) | 两级层次结构、9步状态机、容器分发收集机制 |
| **接口文档 (IFC)** | [接口文档_IFC-FB1001-Conveyor4Layer-V4.1.0.md](四层输送机/接口文档_IFC-FB1001-Conveyor4Layer-V4.1.0.md) | 单层24输入/10输出 + 容器公共+分层接口定义 |
| **使用说明 (UM)** | [使用说明_UM-FB1001-Conveyor4Layer-V4.1.0.md](四层输送机/使用说明_UM-FB1001-Conveyor4Layer-V4.1.0.md) | ST调用示例(容器+单层)、IO地址映射表、多层联动测试 |
| **变更记录 (CHG)** | [变更记录_CHG-FB1001-Conveyor4Layer-V4.1.0.md](四层输送机/变更记录_CHG-FB1001-Conveyor4Layer-V4.1.0.md) | V3→V4重构记录、FB重命名历史、版本变更台帐 |
...
| 文档类型 | 文档名称 | 核心内容 |
|---------|:--------|:--------|
| **详细设计说明书 (DSN)** | [详细设计说明书_DSN-FB1003-PickPlace-V4.1.0.md](取放料机构/详细设计说明书_DSN-FB1003-PickPlace-V4.1.0.md) | 11步状态机、4层循环逻辑、双夹爪控制、产品检测 |
| **接口文档 (IFC)** | [接口文档_IFC-FB1003-PickPlace-V4.1.0.md](取放料机构/接口文档_IFC-FB1003-PickPlace-V4.1.0.md) | 52个输入/18个输出的完整定义、报警码101~108 |
| **使用说明 (UM)** | [使用说明_UM-FB1003-PickPlace-V4.1.0.md](取放料机构/使用说明_UM-FB1003-PickPlace-V4.1.0.md) | ST调用示例、X1轴处理、上下游联调、层循环验证 |
| **变更记录 (CHG)** | [变更记录_CHG-FB1003-PickPlace-V4.1.0.md](取放料机构/变更记录_CHG-FB1003-PickPlace-V4.1.0.md) | 接口扩展历史、V3→V4重构记录、版本变更台帐 |
...
| 文档类型 | 文档名称 | 核心内容 |
|---------|:--------|:--------|
| **详细设计说明书 (DSN)** | [详细设计说明书_DSN-FB1004-GlueMachineFeeder-V4.1.0.md](打胶机送料机构/详细设计说明书_DSN-FB1004-GlueMachineFeeder-V4.1.0.md) | 6步状态机、安全区管理、打胶机交互时序 |
| **接口文档 (IFC)** | [接口文档_IFC-FB1004-GlueMachineFeeder-V4.1.0.md](打胶机送料机构/接口文档_IFC-FB1004-GlueMachineFeeder-V4.1.0.md) | 18个输入/10个输出的完整定义、报警码201~205 |
| **使用说明 (UM)** | [使用说明_UM-FB1004-GlueMachineFeeder-V4.1.0.md](打胶机送料机构/使用说明_UM-FB1004-GlueMachineFeeder-V4.1.0.md) | ST调用示例、X2轴运动处理、参数调优、调试步骤 |
| **变更记录 (CHG)** | [变更记录_CHG-FB1004-GlueMachineFeeder-V4.1.0.md](打胶机送料机构/变更记录_CHG-FB1004-GlueMachineFeeder-V4.1.0.md) | V3→V4重构记录、后续变更追踪、版本变更台帐 |
...
| 文档类型 | 文档名称 | 核心内容 |
|---------|:--------|:--------|
| **详细设计说明书 (DSN)** | [详细设计说明书_DSN-FB2001-CommonAlarm-V4.1.0.md](公共服务/详细设计说明书_DSN-FB2001-CommonAlarm-V4.1.0.md) | 十步处理流程、四大核心算法(OR运算/优先级选取/MES队列/脉冲检测)、D/M区内存布局、报警码段分配原理 |
| **接口文档 (IFC)** | [接口文档_IFC-FB2001-CommonAlarm-V4.1.0.md](公共服务/接口文档_IFC-FB2001-CommonAlarm-V4.1.0.md) | 4输入/10输出完整定义、D400/D402/M200/D404~D425地址映射、15个内部变量说明 |
| **使用说明 (UM)** | [使用说明_UM-FB2001-CommonAlarm-V4.1.0.md](公共服务/使用说明_UM-FB2001-CommonAlarm-V4.1.0.md) | ST调用示例(含D/M区映射)、三站连接关系图、MES集成指南、HMI配置建议、调试流程 |
| **变更记录 (CHG)** | [变更记录_CHG-FB2001-CommonAlarm-V4.1.0.md](公共服务/变更记录_CHG-FB2001-CommonAlarm-V4.1.0.md) | V3→V4重构记录、跨域影响矩阵(3工站+主控+HMI+MES)、版本变更台帐 |
| **报警码定义** | [报警码定义_ALM-DJ-2026-005-V4.1.0.md](公共服务/报警码定义_ALM-DJ-2026-005-V4.1.0.md) | 全局20个报警码完整定义(输送机1~7 + 取放料101~108 + 送料201~205) |
...
- **810_PLC编程规范_DEV-V1.0.3**：项目内部编程规范

### 10.2 编程规范

- **命名规范**：变量和功能块命名采用有意义的英文名称（遵循801_PLC变量命名与功能块命名规范_DEV-V1.0.5）
- **注释规范**：关键代码添加详细注释（采用IEC 61131-3标准的 `(* *)` 格式）
- **结构规范**：采用模块化、扁平化组件设计
- **安全规范**：遵循安全相关编程规范
- **定时器/计数器命名**：采用简化命名规则（tIn/tQ/tR/tPt/tEt for Timer, cIn/cQ/cR/cPv for Counter）

## 11. 文档索引

| 文档类型 | 描述 | 文件位置 |
|----------|------|----------|
| 程序架构文档 | 系统架构概览 | [程序架构文档_ARC-DJ-2026-005-V4.1.0.md](程序架构文档_ARC-DJ-2026-005-V4.1.0.md) |
| 程序设计总文档 | 整体程序设计 | [../程序文档/016_DJ-2026-005_PLC程序设计总文档_PLC-V4.1.0.md](../程序文档/016_DJ-2026-005_PLC程序设计总文档_PLC-V4.1.0.md) |
